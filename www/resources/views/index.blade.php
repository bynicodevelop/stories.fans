<x-guest-layout>
    <div class="flex items-center min-h-screen">
        <div class="max-w-3xl mx-auto">
            <div class="mb-10">
                <h1 class="text-6xl font-semibold leading-tight">@lang('home.main-title')</h1>
                <h2 class="text-4xl font-semibold text-right">@lang('home.secondary-title')</h2>
            </div>

            <div class="mb-10">
                <p class="text-xl mb-3">@lang('home.launch-invitation')</p>
                <p class="text-lg leading-relaxed">@lang('home.do-you-want-invitation')</p>
            </div>
            ...
            <div class="flex flex-wrap justify-evenly">
                ...
                <a class="inline mb-10 md:mb-3" href="https://twitter.com/bystoriesfans">
                    <span class="flex items-center">
                        <svg class="w-9 h-9 inline mr-2" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
     ...
     C480.224,136.96,497.728,118.496,512,97.248z" />
            ...
            <p class="italic text-center mb-10">@lang('home.surprise-in-bio')</p>
            <p class="italic text-center">
                <a href="#stories-fans-wii">@lang('home.stories-fans-what-it-is')</a>
            </p>
        </div>
    </div>

    <div id="stories-fans-wii" class="flex items-center min-h-screen">
        <div class="max-w-3xl mx-auto">
            <h2 class="text-5xl font-semibold leading-tight mb-6">Stories.fans, qu'est-ce que c'est ?</h2>
            <p>Coach, formateur, artiste...</p>
            <p>Proposez du contenu exclusif à votre communauté et générez des revenus sans prise de tête.</p>
        </div>
    </div>
</x-guest-layout>
